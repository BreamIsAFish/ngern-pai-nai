...
describe('transaction time conversion', () => {
  it('converts local form values to UTC fields', () => {
    const input = draftToUtcInput({ localDate: '2026-09-17', localTime: '12:30', type: 'expense', category: 'Food', tag: null, amount: 10, note: '', destination: null, transactionNumber: null, source: 'manual', dateInferred: false })
